  ...
  return (
    <form className="bg-[#F5F5F5] p-6 rounded-lg w-full max-w-xl mx-auto">
      ...
      <div className="flex flex-col space-y-3 mb-6">
        <button onClick={(e) => {e.preventDefault()}} className="w-full p-2 rounded-lg bg-white text-gray-700 font-semibold border border-gray-300 flex items-center justify-center">
          <img
